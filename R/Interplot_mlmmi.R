...
interplot.mlmmi <- function(m, var1, var2, plot = TRUE, steps = NULL, ci = .95, adjCI = FALSE,
...
#' @export
interplot.gmlmmi <- function(m, var1, var2, plot = TRUE, steps = NULL, ci = .95, adjCI = FALSE,
                             hist = FALSE, var2_dt = NA, point = FALSE, sims = 5000,
                             xmin = NA, xmax = NA, ercolor = NA, esize = 0.5, 
                             ralpha = 0.5, rfill = "grey70", ...) {
    set.seed(324)
