...
#' 
#' \code{interplot.default} is a method to calculate conditional coefficient estimates from the results of linear and general linear regression models. 
#' 
...
interplot.default <- function(m, var1, var2, plot = TRUE, point = FALSE,
                              xmin = NA, xmax = NA) {
    set.seed(324)
    
    m.class <- class(m)
    m.sims <- arm::sim(m, 5000)
